...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/pizza-orig.png";
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var pizzaContainer = document.getElementsByClassName("randomPizzaContainer"),
      pizzaContainerLength = pizzaContainer.length,
...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'),
      ...
      currentScrollY = document.body.scrollTop / 1250,
      sinArray = [];

  for (i = 0; i < 5; i++) {
      sinArray.push(Math.sin(currentScrollY + i));
  }

  for (var i = 0; i < itemsLength; i++) {
    var phase = sinArray[i % 5];
    items[i].style.transform = 'translate3d('+ (100 * phase) + 'px, 0, 0)'; //translate3d pushes CSS animations into hardware acceleration
  }
